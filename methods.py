# Method: they are called on an instance of the class. The instance is passed as the first argument to the method, conventionally named self.
# this class will check validity of data like email, age etc.
class DataValidator:
    def __init__(self):
        self.errors = []
