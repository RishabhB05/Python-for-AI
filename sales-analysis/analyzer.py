...
# # we can also access files outisde of sales-analysis folder
# data_path2 = "../data/paris_weather.csv"
...
# ----------------------------------------------
# Actual sales analysis code starts here - read the upper part for understanding the basic
# import pandas as pd
# import json
# import os
...
#------------------------------------------------------------------
#using helper functions from helpers.py to make the code simple
# analyzer.py
import pandas as pd
